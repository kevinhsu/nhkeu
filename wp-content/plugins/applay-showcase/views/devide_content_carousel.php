...
<div class="ias-devide-content ias-devide-content-carousel">
    ...
    foreach( $carousel as $carousel_item){
        ...
        <?php $thumbnail = wp_get_attachment_image_src($carousel_item,'full', true); ?>
        	...
        	<div class="hidden">
                <div class="popup-data dark-div">
                    ...
                    <div class="popup-data-content">
                        <h5><a href="<?php echo get_permalink($carousel_item); ?>" title="<?php the_title_attribute(); ?>"><?php echo get_the_title($attachment_id); ?></a></h5>
                    </div>
                </div>
            </div><!--/hidden-->
	<?php }
